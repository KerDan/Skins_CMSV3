...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="stylecontext" select="concat($cmscontext, '/skins/', $skin, '/templates/', $template, '/styles/', $styleName)"/>
	...
	<xsl:template match="content">
		<html>
			<head>
  				...
  				<link href="{$stylecontext}/css/print.css" rel="stylesheet" type="text/css"/>
			</head>
			<body>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					 <tr>
						<td height="28" background="{$stylecontext}/img/page_title_bkg.gif" class="page_title_bkg">
							<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><img src="{$stylecontext}/img/page_title_bullet.gif" width="33" height="32"/></td>
								<td valign="top">
