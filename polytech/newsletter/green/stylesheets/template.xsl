	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<link type="text/css" href="{$skincontext}/css/newsletter/green.css" rel="stylesheet" media="screen" />
				...
				<style type="text/css" media="screen, print">
					...
					#toc {
						background: #9fff40 url('<xsl:value-of select="$skincontext"/>/img/green/master-bg.jpg') repeat-x top left;
					}
